...
export default function AntiportfolioDocumentDestruction() {
      ...
      <div className="w-full max-w-md">
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-3xl shadow-2xl p-8 relative overflow-visible border border-slate-700">
          ...
          <div className="relative mb-6 min-h-[120px]">
            ...
            {/* Upload Area - neutrale */}
            {!file && !isDestroying && (
              <label className="block border-2 border-dashed border-slate-600 rounded-xl p-8 text-center cursor-pointer hover:border-slate-400 hover:bg-slate-700/30 transition-all duration-300 group">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-slate-700 flex items-center justify-center group-hover:bg-slate-600 transition-colors">
                ...
                <p className="text-slate-400 group-hover:text-slate-300 transition-colors font-medium">Trascina qui il tuo CV</p>
                <p className="text-slate-600 text-sm mt-1">PDF, DOC, DOCX</p>
                <input
                  type="file"
                  className="hidden"
                  accept=".pdf,.doc,.docx"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-3xl shadow-2xl max-w-lg w-full animate-modal-rise border border-slate-700/50 overflow-hidden">
            ...
            <div className="relative z-10 p-10">
              ...
              <div className={`text-center mb-8 transition-all duration-700 ${modalPhase >= 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <div className="mb-4">
